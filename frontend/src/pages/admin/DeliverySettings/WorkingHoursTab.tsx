  ...
  return (
    <div className="space-y-10">
      ...
      <div className="bg-slate-900 border border-slate-800 p-6 rounded-2xl flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h3 className="text-xl font-bold text-white mb-1">Status Manual da Loja</h3>
        ...
        <button 
          ...
          className={`flex items-center justify-center gap-2 px-6 py-3 rounded-xl font-bold text-white transition-all w-full md:w-auto
      ...
      <div className="space-y-4">
        ...
        {Object.keys(hours).map(day => (
          <div key={day} className="bg-slate-900/50 p-4 rounded-xl border border-slate-800 flex flex-col md:flex-row md:items-start gap-4">
            <div className="w-32 capitalize font-bold text-slate-300 pt-2">
              ...
              {(hours[day] || []).map((shift: any, index: number) => (
                <div key={index} className="flex items-center gap-3">
                  <input 
                    ...
                    className="bg-slate-950 border border-slate-700 text-white rounded-lg px-3 py-2 focus:border-indigo-500 outline-none"
                  />
